...
Access to a running Verus Node e.g (testnet) https://api.verustest.net, (mainnet) https://api.verus.services or your own - find more information here: https://verus.io/wallet.

### 2.

A VerusId for signing - can be created in Verus Desktop App or Verus CLI - find more information here: https://verus.io/wallet.

### 3.

The private key (WIF) of the R address that holds above VerusId
...
1. Change the name of the .env.example file to .env and update the values to your Login servers Identity, PrivateKey, change JWT secret (Use at least 32 random characters) and changes your servers endpoint.
